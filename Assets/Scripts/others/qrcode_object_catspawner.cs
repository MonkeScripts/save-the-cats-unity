    ...
    // public class qrcode_object_catspawner : MonoBehaviour
    // {
    ...
    //     // This method catches the MQTT message
    ...
    //         {
    //             Debug.Log($"{TAG} MQTT 'hehe' triggered a cat spawn!");
    //             SpawnCatFromCube(); 
    //         }
    //     }
